...
> 상태: 착수 기준선(2026-08-13 작성, 2026-08-27 판). 이후 변경(예: startup 의 Redis 확인)은
> 반영하지 않는다. 현재 동작은 `docs/guides/ARCHITECTURE.md`·`docs/guides/DEVELOPMENT.md`,
> 결정 이력은 `docs/crp/groups/orm-raw-repository/design-baseline.md` 를 따른다.
...
> 당시 로컬 작업 기록(`docs/2026-08-25/`, `.gitignore` 대상이라 저장소에 없음)의 정정 블록에 있었다.
> 로그 리스너 수명(ADR-018·022·023)의 배경은 `docs/guides/ARCHITECTURE.md` §9 를 보라.
