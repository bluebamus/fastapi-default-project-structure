...
- **ledger Open Fix 0건** (F-001 ~ F-023 — F-022 까지 Fixed, F-023 은 Accept-out-of-scope).
- 마지막 게이트 실행: 전건 통과(**검사 9종**) · **391 tests** · MySQL 통합 **8건** 실제 실행 — Round 9 (2026-08-20).
...
향후 이 그룹에 새 요청이 오면 Round 10 을 이 아래에 추가한다. `residual-risk.md` 의
